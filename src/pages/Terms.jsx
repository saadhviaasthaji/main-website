      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <Reveal>
          ...
          <div className="prose prose-lg text-gray-600 font-sans">
            ...
            <h2 className="text-2xl font-serif text-brand-charcoal mt-8 mb-4">1. Acceptance of Terms</h2>
            ...
            <h2 className="text-2xl font-serif text-brand-charcoal mt-8 mb-4">2. Use License</h2>
            ...
            <h2 className="text-2xl font-serif text-brand-charcoal mt-8 mb-4">3. Disclaimer</h2>
