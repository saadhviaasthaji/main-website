  ...
  return (
    <div className="pt-32 pb-20 bg-transparent min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <Reveal>
          <h1 className="text-4xl font-serif text-[#a63c06] mb-8">Privacy Policy</h1>
          <div className="prose prose-lg text-[#c36f09] font-sans">
            <p className="mb-4">Last updated: [Date]</p>
            
            <h2 className="text-2xl font-serif text-[#a63c06] mt-8 mb-4">1. Information We Collect</h2>
            ...
            <h2 className="text-2xl font-serif text-[#a63c06] mt-8 mb-4">2. How We Use Information</h2>
            ...
            <h2 className="text-2xl font-serif text-[#a63c06] mt-8 mb-4">3. Sharing of Information</h2>
