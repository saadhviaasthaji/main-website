...
const SocialMediaBar = () => {
  const socials = [
    { icon: <FaInstagram size={28} />, name: 'Instagram', link: 'https://www.instagram.com/saadhviaasthaji?stkn=NGtkNDdobWd1bWM5&utm_source=qr' },
    { icon: <FaYoutube size={28} />, name: 'YouTube', link: 'https://youtube.com/@saadhviaasthaji?si=R0foofcMK9RvUxRN' },
    { icon: <FaFacebookF size={28} />, name: 'Facebook', link: 'https://www.facebook.com/share/1BaFeRuB4G/?mibextid=wwXIfr' },
    { icon: <FaXTwitter size={28} />, name: 'X', link: 'https://x.com/saadhviaasthaji?s=11' },
  ];
