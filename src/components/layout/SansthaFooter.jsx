    ...
    <footer className="bg-transparent text-[#a63c06] pt-12 pb-6 border-t border-gray-200">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-6 flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row gap-8 mb-8">
              ...
              <div>
                ...
                <a href="mailto:aasthasevabhavi.org@gmail.com" className="text-[#c36f09] text-base hover:text-[#a63c06] transition-colors flex items-center gap-2">
                  <Mail size={18} className="text-[#a63c06]" /> aasthasevabhavi.org@gmail.com
                </a>
              </div>
            </div>
        ...
        <div className="border-t border-gray-300 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-[#c36f09]">
          <p>&copy; {new Date().getFullYear()} Aastha Sevabhavi Sanstha . Powered by PM Talents</p>
        </div>
      </div>
    </footer>
  );
