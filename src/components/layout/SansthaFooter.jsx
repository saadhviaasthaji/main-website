      ...
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-8">
          ...
          <div className="lg:col-span-6 flex flex-col">
            <h2 className="text-3xl font-serif text-brand-charcoal mb-4 font-bold self-start">
          ...
          <div className="lg:col-span-3 lg:col-start-8">
            ...
            <div className="flex flex-col space-y-3">
              <Link to="/sanstha/about" className="text-brand-charcoal/80 text-base hover:text-brand-charcoal hover:translate-x-1 transition-all">About Us</Link>
              <Link to="/sanstha/our-works" className="text-brand-charcoal/80 text-base hover:text-brand-charcoal hover:translate-x-1 transition-all">Our Works</Link>
              <Link to="/sanstha/gallery" className="text-brand-charcoal/80 text-base hover:text-brand-charcoal hover:translate-x-1 transition-all">Gallery</Link>
          ...
          <div className="lg:col-span-2">
            <h3 className="text-xl font-bold font-serif mb-4 text-brand-charcoal">Get Involved</h3>
            <div className="flex flex-col space-y-3">
              <Link to="/sanstha/roti-bank" className="text-brand-charcoal/80 text-base hover:text-brand-charcoal hover:translate-x-1 transition-all">Roti Bank Initiative</Link>
              ...
              <Link to="/sanstha/membership" className="text-brand-charcoal/80 text-base hover:text-brand-charcoal hover:translate-x-1 transition-all">Become a Member</Link>
            </div>
          </div>
        ...
        <div className="border-t border-gray-300 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-brand-charcoal/80">
          <p>&copy; {new Date().getFullYear()} Aastha Sevabhavi Sanstha . Powered by <a href="https://ri5ing.is-a.dev/" target="_blank" rel="noreferrer" className="font-semibold text-brand-charcoal hover:text-black transition-colors">ri5ing</a></p>
        </div>
      </div>
    </footer>
  );
