        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex-shrink-0 flex items-center">
              <Link to="/">
                <img src="https://see.fontimg.com/api/rf5/7BWnK/OWIxZDJiOTU1MThlNDNiMGFkZWQ3ZGUwMjU4MTllMWYub3Rm/U2FhZGh2aSBBYXN0aGEgSmk/brother-signature.png?r=fs&h=70&w=1250&fg=000000&bg=FFFFFF&tb=1&s=56" alt="Saadhvi Aastha Ji Logo" className={`h-10 md:h-12 object-contain transition-all duration-300 ${!isScrolled ? 'invert mix-blend-screen' : 'mix-blend-multiply'}`} />
              </Link>
            </div>
            ...
            <div className="flex items-center space-x-2 md:space-x-4">
              <div className="hidden md:block">
                <Link to="/sanstha" className="px-6 py-2.5 bg-transparent text-white border border-white font-semibold rounded-none transition-all hover:bg-white hover:text-black hover:scale-105 transform">
                  Sanstha Works
                </Link>
              </div>
