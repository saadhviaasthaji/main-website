            ...
            {stats.map((stat, idx) => (
              <div key={idx} className="text-center relative">
                ...
                <motion.h3 
                  ...
                  className="text-5xl md:text-6xl lg:text-7xl font-serif mb-4 text-white"
                >
                  {stat.value}
                </motion.h3>
                <p className="text-sm md:text-base tracking-widest uppercase font-bold text-white/60">
                  {stat.label}
                </p>
              </div>
            ))}
