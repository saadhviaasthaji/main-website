          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-[#c36f09] font-sans text-lg mb-8 max-w-xl">
                <AnimatedText section="sansthaAbout" tKey="legalDesc" />
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h4 className="font-bold uppercase tracking-widest text-xs text-gray-300 mb-2"><AnimatedText section="sansthaAbout" tKey="legal1Title" /></h4>
                  <p className="font-serif text-xl text-white"><AnimatedText section="sansthaAbout" tKey="legal1Desc" /></p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <h4 className="font-bold uppercase tracking-widest text-xs text-gray-300 mb-2"><AnimatedText section="sansthaAbout" tKey="legal2Title" /></h4>
                  <p className="font-serif text-xl text-white"><AnimatedText section="sansthaAbout" tKey="legal2Desc" /></p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <h4 className="font-bold uppercase tracking-widest text-xs text-gray-300 mb-2"><AnimatedText section="sansthaAbout" tKey="legal3Title" /></h4>
                  <p className="font-serif text-xl text-white"><AnimatedText section="sansthaAbout" tKey="legal3Desc" /></p>
                  <p className="text-gray-300 text-sm mt-1"><AnimatedText section="sansthaAbout" tKey="legalNote" /></p>
                </div>
              </motion.div>
            </div>
          </div>
