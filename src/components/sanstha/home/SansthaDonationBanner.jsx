  ...
  return (
    <section className="py-24 bg-transparent relative overflow-hidden">
      ...
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 relative z-10">
        <Reveal>
          <div className="bg-brand-charcoal text-white rounded-[2rem] p-10 md:p-16 text-center shadow-2xl">
            ...
            <Link to="/sanstha/donation" className="inline-block bg-white text-black font-bold font-sans py-4 px-10 rounded-full shadow-lg hover:bg-gray-200 transition-all duration-300 transform hover:-translate-y-1 uppercase tracking-widest text-sm">
              Donate Now
            </Link>
          </div>
        </Reveal>
